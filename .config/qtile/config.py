...
keys = [
    ...
    Key(
		[mod], "t",
		lazy.spawn(rofi_applets + 'rofi_themes'),
		desc="Run themes applet"
	),
...
## Layouts ------------------------------
var_bg_color = '#0F161C'
var_active_bg_color = '#5B7C83'
var_active_fg_color = '#c0cbcb'
var_inactive_bg_color = '#18232c'
var_inactive_fg_color = '#c0cbcb'
var_urgent_bg_color = '#50696F'
var_urgent_fg_color = '#c0cbcb'
var_section_fg_color = '#F59E0A'
var_active_color = '#5B7C83'
var_normal_color = '#18232c'
var_border_width = 2
var_margin = [5,5,5,5]
var_gap_top = 43
var_gap_bottom = 5
